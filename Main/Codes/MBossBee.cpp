...
C_MBossBee::C_MBossBee() :C_MBoss()
{
}


C_MBossBee::~C_MBossBee()
{
	Release();
}

HRESULT C_MBossBee::Initialize()
{
	C_Enemy::Initialize();

	m_pMeshKey = L"MBossBee";
...
void C_MBossBee::Release()
{

}

void C_MBossBee::SetContantTable()
{
